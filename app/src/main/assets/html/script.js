...
function OnButtonClickNew() {
    ...
    // リモートのクラスからオブジェクトを作成
    console.log("new MyClassJava");
    var _this = this;
    objectChannel.create("MyClassJava", ["JS"], function(error, object) {
        _this.object = object;
...
function OnButtonClickInvoke() {
    ...
    console.log("invoke MyClassJava.foo");
    this.object.invoke("foo", ["a1", "a2", "a3"], function(error, result) {
        console.log("executed MyClassJava.foo: result=" + result);
        alert("result: " + result);
    });
}
...
function OnButtonClickInvokeA() {
    ...
    console.log("invoke MyClassJava.fooA");
    this.object.invoke("fooA", ["a1", "a2", "a3"], function(error, result) {
        console.log("executed MyClassJava.fooA: result=" + result);
        alert("result: " + result);
    });
}
...
function OnButtonClickDestroy() {
    ...
    console.log("invoke destructor of MyClassJava");
    this.object.destroy();
